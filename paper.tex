...
VCF data model into an array-oriented layout based on the
widely-used Zarr format (Fig~\ref{fig-data-model}). 
Briefly, Zarr stores multidimensional arrays of a given datatype
as compressed fixed-size chunks. In the VCF Zarr specification, 
