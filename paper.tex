...
10,221 variants and 42.3 GiB of storage. We first converted the VCF
data to ICF, which took 8m 55s elapsed (138m CPU) using 20 processes.
%TODO There is an XX HERE
The ICF representation required a total of 41 GiB over XX files.
We then converted to VCF Zarr format using the default schema, which resulted
in a 41 GiB VCZ. On inspection, this was dominated by three floating point
...
\begin{table}
\caption{Summary for VCF Zarr conversion of 
%TODO Text says chr 22, this caption says chr 20, I'm not sure which is right
...
single 345 MiB Zip file, 241 MiB of which is used by the alignment data. This
