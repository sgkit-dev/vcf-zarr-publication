...
The All of Us dataset comprises 245,388 clinical-grade whole genome sequences,
identifying over 1 billion variants, including 3.9 million novel variants with
coding consequences~\citep{all2024genomic}. 
Participants are from the United States, with an emphasis
on historically underrepresented genetic ancestry groups. The genomic data is
of high quality, with an average coverage depth of 30x, and is linked to
extensive health-related information, providing a valuable resource for
biomedical research. For this study, we applied the bio2zarr compression method
to the exome-like data for chromosome 20 from All of Us. This dataset, stored as a
compressed VCF file of 7.44 GiB, includes 681,000 variants, of which 746 are
