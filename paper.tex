...
fairly weak influence on compression ratio. While larger 
sample chunk sizes lead to a slight increase in compression
ratio on the more compressable fields, the overall effect
on total storage used will be slight. Variant chunk size 
appears to have no effect on compression ratio. Thus, we 
do not expect the choice of chunk size to have a significant
