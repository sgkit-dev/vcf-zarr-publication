...
standard bucket. We repeated the benchmarks above the same subset
562,640 variants, and the same 
...
While these benchmarks are comparable with results obtained from the 
...
network data rate of 
% FIXME MiB/s
127 MB/s, far below the capbility of the instance,
indicating that this process was compute-constrained. 
