...
data from the All of Us dataset. The exome-like data is constructed by extracting from the WGS 
the SNP and Indel variants that lie within the chromosome 20 exon regions of the Gencode v42 basic 
transcripts for all samples. This dataset, stored as a compressed VCF file of 7.44 GiB, 
