...
workflows. Methods that require efficient access to genotype data
...
Downstream processing of these datasets can be split into a 
...
and properties of the data and substantial computation.
...
Hail distributes calculations and data transparently over a cluster, enabling
...
and exported to additional (large) files.
...
analyses, to find regions or variants of interest for a particular 
