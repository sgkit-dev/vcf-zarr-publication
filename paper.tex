...
(A) Schematic of data stored under the \texttt{vcfzarr} specification.
...
widely-used Zarr format (Fig~\ref{fig-data-storage}A). 
...
on the genotype matrix. In Fig~\ref{fig-data-storage}B
...
[Review computational accessibility of the available formats.
We have those that only produce VCF in response to limited 
query languages. Those with APIs.]
