...
Glow~\cite{glow2024} has recently emerged as a similar approach
to performing distributed analytics on genetic variation data.
While Hail and Glow are built on open components
from the Hadoop distributed computing ecosystem~\citep{white2012hadoop},
they are both complex projects consisting of 
tightly coupled components that are not intended for external reuse.
