...
processes. This level of throughput would complete af-dist for all
chromosomes for all samples (104 TiB of genotype data)
% timing: 722000000 * 79000 * 2bytes = 104 TiB
% 104TiB / 25.5GiB/s = 1.16 hours
% compute: cost of c5.9xlarge per hour * 1.16
% ==                             $4.08 * 1.16
...
in 1.16 hours for a compute cost of \$4.73 and an IO cost of \$2.28.

Using this parallel architecture, the af-dist calculation for the target 
% 180.80 MB in 4503 files
% Total data: 90060.00 MB in 4503 chunks
region used for the single threaded benchmarks above ---172 MiB retrieved in 4503
chunks, 83.87 GiB of genotype data decompressed and processed---
% This gives an effective rate lower than  25.5G above:  83.87 / 4.15 = 20.2
was completed in 4.15s. A slightly slower effective throughput than in
Fig~\ref{fig-s3-throughput} as the short time to completion means that
the timing is sensitive to set-up and tear-down costs.
