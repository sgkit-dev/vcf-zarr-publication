...
runtime, generating a dataset with 32 arrays, consuming a total of 6.7
TiB storage over 11,984,581 chunk files. The reduction in total
storage (1.1X) is negligible, presumably due to the small sample size.
The top fields in terms of storage are detailed in
Table~\ref{tab-spruce-data}.
