...
storage is reduced to 22.07GiB (not shown).
...
(2.9GiB/s) at the cost of a roughly 25\% increase in storage
...
A substantial advantage of Zarr is the availabilty of several 
independent implementations across different programming languages
(see Methods). Figure~\ref{fig-whole-matrix-compute-zarr-versions}
compares the CPU time required to perform the computations
of Figure~\ref{fig-whole-matrix-compute} 
...
The version using the Tensorstore C++ API is fastest, requiring 
about 20\% less time than Zarr-Python (which is used in other
benchmarks).

% num_samples  num_sites       tool  user_time  sys_time     wall_time
% storage  total_time
% 22      1000000    7254858       zarr   16709.55     38.14  16910.057917
% hdd    4.652136
% 20      1000000    7254858     ts_cpp   13233.50     92.81  13573.456810
% hdd    3.701753
% 21      1000000    7254858  zarr_java   43780.50    245.28  44134.462377
% hdd   12.229383
% 23      1000000    7254858      ts_py   18027.43    642.40  19163.174182
% hdd    5.186064
