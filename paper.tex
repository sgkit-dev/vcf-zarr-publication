...
collecting genome sequence data for millions of humans.
...
consisting of 34 fields and 2.3TiB of storage ($\sim 3.2X$ smaller 
than source gzipped VCFs). The chunk size is 10,000 variants times 
...
an AWS S3 standard bucket. 
[TODO clarify what we're doing and remind reader]
...
into RAM. [TODO QUESTION: can such rates be sustained, and be expected to 
happen in parallel? Do Durner et al consider this?]
